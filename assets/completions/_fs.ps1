...
Register-ArgumentCompleter -Native -CommandName 'fs' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'fs' {
            ...
            [CompletionResult]::new('--lock-prompt', '--lock-prompt', [CompletionResultType]::ParameterName, 'Lock the prompt at startup')
        ...
        'fs;:open' {
            ...
            [CompletionResult]::new('--opener', '--opener', [CompletionResultType]::ParameterName, 'Program used to open files on accept')
            [CompletionResult]::new('--list', '--list', [CompletionResultType]::ParameterName, 'list')
            [CompletionResult]::new('-o', '-o', [CompletionResultType]::ParameterName, 'Start with a minimal keymap: navigation, selection, accept/quit, preview, and query editing only')
            [CompletionResult]::new('--simple-ui', '--simple-ui', [CompletionResultType]::ParameterName, 'Start with a minimal keymap: navigation, selection, accept/quit, preview, and query editing only')
