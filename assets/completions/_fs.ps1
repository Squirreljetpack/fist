...
Register-ArgumentCompleter -Native -CommandName 'fs' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'fs' {
            ...
            [CompletionResult]::new('--fullscreen', '--fullscreen', [CompletionResultType]::ParameterName, 'Start f:ist in fullscreen. Optionally, the orientation of the results can be given also be given here (true/false).')
