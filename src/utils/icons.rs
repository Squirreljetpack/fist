use cli_boilerplate_automation::{bath::basename, bs::FsPathExt};
...
#[rustfmt::skip]
impl Icons {
    pub const HOME: char            = '\u{f04c6}';
    pub const AUDIO: char           = '\u{f001}';  // 
    pub const BINARY: char          = '\u{eae8}';  // 
    pub const BOOK: char            = '\u{e28b}';  // 
    pub const CALENDAR: char        = '\u{eab0}';  // 
    pub const CACHE: char           = '\u{f49b}';  // 
    pub const CAD: char             = '\u{f0eeb}'; // 󰻫
    pub const CLOCK: char           = '\u{f43a}';  // 
    pub const COMPRESSED: char      = '\u{f410}';  // 
    pub const CONFIG: char          = '\u{f107b}'; // 󱁻
    pub const CSS3: char            = '\u{e749}';  // 
    pub const DATABASE: char        = '\u{f1c0}';  // 
    pub const DIFF: char            = '\u{f440}';  // 
    pub const DISK_IMAGE: char      = '\u{e271}';  // 
    pub const DOCKER: char          = '\u{e650}';  // 
    pub const DOCUMENT: char        = '\u{f1c2}';  // 
    pub const DOWNLOAD: char        = '\u{f01da}'; // 󰇚
    pub const EDA_SCH: char         = '\u{f0b45}'; // 󰭅
    pub const EDA_PCB: char         = '\u{eabe}';  // 
    pub const EMACS: char           = '\u{e632}';  // 
    pub const ESLINT: char          = '\u{e655}';  // 
    pub const FILE: char            = '\u{f15b}';  // 
    pub const FILE_3D: char         = '\u{f01a7}'; // 󰆧
    pub const FOLDER: char          = '\u{e5ff}';  // 
    pub const FOLDER_BUILD: char    = '\u{f19fc}'; // 󱧼
    pub const FOLDER_CONFIG: char   = '\u{e5fc}';  // 
    pub const FOLDER_EXERCISM: char = '\u{ebe5}';  // 
    pub const FOLDER_GIT: char      = '\u{e5fb}';  // 
    pub const FOLDER_GITHUB: char   = '\u{e5fd}';  // 
    pub const FOLDER_HIDDEN: char   = '\u{f179e}'; // 󱞞
    pub const FOLDER_KEY: char      = '\u{f08ac}'; // 󰢬
    pub const FOLDER_NPM: char      = '\u{e5fa}';  // 
    pub const FOLDER_OCAML: char    = '\u{e67a}';  // 
    pub const FOLDER_OPEN: char     = '\u{f115}';  // 
    pub const FILE_UNKNOW: char     = '\u{f086f}'; // 󰡯
    pub const FONT: char            = '\u{f031}';  // 
    pub const FREECAD: char         = '\u{f336}';  // 
    pub const GIMP: char            = '\u{f338}';  // 
    pub const GIST_SECRET: char     = '\u{eafa}';  // 
    pub const GIT: char             = '\u{f02a2}'; // 󰊢
    pub const GODOT: char           = '\u{e65f}';  // 
    pub const GRADLE: char          = '\u{e660}';  // 
    pub const GRAPH: char           = '\u{f1049}'; // 󱁉
    pub const GRAPHQL: char         = '\u{e662}';  // 
    pub const GRUNT: char           = '\u{e611}';  // 
    pub const GTK: char             = '\u{f362}';  // 
    pub const GULP: char            = '\u{e610}';  // 
    pub const HTML5: char           = '\u{f13b}';  // 
    pub const IMAGE: char           = '\u{f1c5}';  // 
    pub const INFO: char            = '\u{f129}';  // 
    pub const INTELLIJ: char        = '\u{e7b5}';  // 
    pub const JSON: char            = '\u{e60b}';  // 
    pub const KEY: char             = '\u{eb11}';  // 
    pub const KDENLIVE: char        = '\u{f33c}';  // 
    pub const KEYPASS: char         = '\u{f23e}';  // 
    pub const KICAD: char           = '\u{f34c}';  // 
    pub const KRITA: char           = '\u{f33d}';  // 
    pub const LANG_ARDUINO: char    = '\u{f34b}';  // 
    pub const LANG_ASSEMBLY: char   = '\u{e637}';  // 
    pub const LANG_C: char          = '\u{e61e}';  // 
    pub const LANG_CPP: char        = '\u{e61d}';  // 
    pub const LANG_CSHARP: char     = '\u{f031b}'; // 󰌛
    pub const LANG_D: char          = '\u{e7af}';  // 
    pub const LANG_ELIXIR: char     = '\u{e62d}';  // 
    pub const LANG_FENNEL: char     = '\u{e6af}';  // 
    pub const LANG_FORTRAN: char    = '\u{f121a}'; // 󱈚
    pub const LANG_FSHARP: char     = '\u{e7a7}';  // 
    pub const LANG_GLEAM: char      = '\u{f09a5}'; // 󰦥
    pub const LANG_GO: char         = '\u{e65e}';  // 
    pub const LANG_GROOVY: char     = '\u{e775}';  // 
    pub const LANG_HASKELL: char    = '\u{e777}';  // 
    pub const LANG_HDL: char        = '\u{f035b}'; // 󰍛
    pub const LANG_HOLYC: char      = '\u{f00a2}'; // 󰂢
    pub const LANG_JAVA: char       = '\u{e256}';  // 
    pub const LANG_JAVASCRIPT: char = '\u{e74e}';  // 
    pub const LANG_KOTLIN: char     = '\u{e634}';  // 
    pub const LANG_LUA: char        = '\u{e620}';  // 
    pub const LANG_NIM: char        = '\u{e677}';  // 
    pub const LANG_OCAML: char      = '\u{e67a}';  // 
    pub const LANG_PERL: char       = '\u{e67e}';  // 
    pub const LANG_PHP: char        = '\u{e73d}';  // 
    pub const LANG_PYTHON: char     = '\u{e606}';  // 
    pub const LANG_R: char          = '\u{e68a}';  // 
    pub const LANG_RUBY: char       = '\u{e739}';  // 
    pub const LANG_RUBYRAILS: char  = '\u{e73b}';  // 
    pub const LANG_RUST: char       = '\u{e68b}';  // 
    pub const LANG_SASS: char       = '\u{e603}';  // 
    pub const LANG_SCHEME: char     = '\u{e6b1}';  // 
    pub const LANG_STYLUS: char     = '\u{e600}';  // 
    pub const LANG_TEX: char        = '\u{e69b}';  // 
    pub const LANG_TYPESCRIPT: char = '\u{e628}';  // 
    pub const LANG_V: char          = '\u{e6ac}';  // 
    pub const LIBRARY: char         = '\u{eb9c}';  // 
    pub const LICENSE: char         = '\u{f02d}';  // 
    pub const LOCK: char            = '\u{f023}';  // 
    pub const LOG: char             = '\u{f18d}';  // 
    pub const MAKE: char            = '\u{e673}';  // 
    pub const MARKDOWN: char        = '\u{f48a}';  // 
    pub const MUSTACHE: char        = '\u{e60f}';  // 
    pub const NEWS: char            = '\u{f1ea}';  // 
    pub const NODEJS: char          = '\u{e718}';  // 
    pub const NOTEBOOK: char          = '\u{e678}';  // 
    pub const NPM: char             = '\u{e71e}';  // 
    pub const OS_ANDROID: char      = '\u{e70e}';  // 
    pub const OS_APPLE: char        = '\u{f179}';  // 
    pub const OS_LINUX: char        = '\u{f17c}';  // 
    pub const OS_WINDOWS: char      = '\u{f17a}';  // 
    pub const OS_WINDOWS_CMD: char  = '\u{ebc4}';  // 
    pub const PLAYLIST: char        = '\u{f0cb9}'; // 󰲹
    pub const POWERSHELL: char      = '\u{ebc7}';  // 
    pub const PRIVATE_KEY: char     = '\u{f0306}'; // 󰌆
    pub const PUBLIC_KEY: char      = '\u{f0dd6}'; // 󰷖
    pub const QT: char              = '\u{f375}';  // 
    pub const RAZOR: char           = '\u{f1fa}';  // 
    pub const REACT: char           = '\u{e7ba}';  // 
    pub const README: char          = '\u{f00ba}'; // 󰂺
    pub const SHEET: char           = '\u{f1c3}';  // 
    pub const SHELL: char           = '\u{f1183}'; // 󱆃
    pub const SHELL_CMD: char       = '\u{f489}';  // 
    pub const SHIELD_CHECK: char    = '\u{f0565}'; // 󰕥
    pub const SHIELD_KEY: char      = '\u{f0bc4}'; // 󰯄
    pub const SHIELD_LOCK: char     = '\u{f099d}'; // 󰦝
    pub const SIGNED_FILE: char     = '\u{f19c3}'; // 󱧃
    pub const SLIDE: char           = '\u{f1c4}';  // 
    pub const SQLITE: char          = '\u{e7c4}';  // 
    pub const SUBLIME: char         = '\u{e7aa}';  // 
    pub const SUBTITLE: char        = '\u{f0a16}'; // 󰨖
    pub const TCL: char             = '\u{f06d3}'; // 󰛓
    pub const TERRAFORM: char       = '\u{f1062}'; // 󱁢
    pub const TEXT: char            = '\u{f15c}';  // 
    pub const TODO: char            = '\u{f0ae}';  // 
    pub const TYPST: char           = '\u{f37f}';  // 
    pub const TMUX: char            = '\u{ebc8}';  // 
    pub const TOML: char            = '\u{e6b2}';  // 
    pub const TRANSLATION: char     = '\u{f05ca}'; // 󰗊
    pub const UNITY: char           = '\u{e721}';  // 
    pub const VECTOR: char          = '\u{f0559}'; // 󰕙
    pub const VIDEO: char           = '\u{f03d}';  // 
    pub const VIM: char             = '\u{e7c5}';  // 
    pub const WRENCH: char          = '\u{f0ad}';  // 
    pub const XML: char             = '\u{f05c0}'; // 󰗀
    pub const XORG:char             = '\u{f369}';  // 
    pub const YAML: char            = '\u{e6a8}';  // 
    pub const YARN: char            = '\u{e6a7}';  // 
}
...
pub fn icon_for_file(path: &Path) -> char {
    if path.is_dir() {
        *DIRECTORY_ICONS.get(&basename(path)).unwrap_or_else(|| {
    ...
    } else if let Some(icon) = FILENAME_ICONS.get(&basename(path)) {
        *icon
    } else if let Some(ext) = path.extension() {
        *EXTENSION_ICONS
            .get(&ext.to_string_lossy())
